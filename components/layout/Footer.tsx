      ...
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold text-primary">BIBA</h3>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/categories/kurtas" className="text-muted-foreground hover:text-primary">
                  Kurtas
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/categories/suits" className="text-muted-foreground hover:text-primary">
                  Suits
                </Link>
              </li>
              <li>
